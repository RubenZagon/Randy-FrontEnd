...
export const Icon: FC<IconProps> = ({ name, active }) => {
  switch (name) {
    case "dashboard":
      return (
        <DivIcon active={active}>
          <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="21.4286" height="13.0645" rx="2" fill="#FFFFFF" />
            <rect y="15.9677" width="21.4286" height="29.0323" rx="2" fill="#FFFFFF" />
            <rect width="21.4286" height="13.0645" rx="2" transform="matrix(1 0 0 -1 23.5714 45)" fill="#FFFFFF" />
            <rect width="21.4286" height="29.0323" rx="2" transform="matrix(1 0 0 -1 23.5714 29.0323)" fill="#FFFFFF" />
          </svg>
        </DivIcon>
      );
    case "calendar":
    ...
    case "tasklist":
      return (
        <DivIcon active={active}>
          <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="2.25" y="24.75" width="7.5" height="7.5" rx="2" fill="#FFFFFF" />
            <rect x="13.5" y="25.5" width="30" height="6" rx="3" fill="#FFFFFF" />
            <rect x="2.25" y="36.75" width="7.5" height="7.5" rx="2" fill="#FFFFFF" />
            <rect x="13.5" y="37.5" width="30" height="6" rx="3" fill="#FFFFFF" />
            <rect x="13.5" y="13.5" width="30" height="6" rx="3" fill="#FFFFFF" />
            <path fillRule="evenodd" clipRule="evenodd" d="M4.25 12.75C3.14543 12.75 2.25 13.6454 2.25 14.75V16.7891V18.25C2.25 19.3546 3.14543 20.25 4.25 20.25H7.75C8.85457 20.25 9.75 19.3546 9.75 18.25V14.75C9.75 14.6279 9.73905 14.5083 9.71808 14.3922L5.14652 19.6856L2.25 16.7891L3.17522 15.8638L5.07635 17.765L8.75973 13.5L9.70236 14.3141C9.50342 13.4191 8.70485 12.75 7.75 12.75H4.25Z" fill="#FFFFFF" />
            <rect x="13.5" y="1.5" width="30" height="6" rx="3" fill="#FFFFFF" />
            <path fillRule="evenodd" clipRule="evenodd" d="M4.25 0.75C3.14543 0.75 2.25 1.64543 2.25 2.75V4.78905V6.25C2.25 7.35457 3.14543 8.25 4.25 8.25H7.75C8.85457 8.25 9.75 7.35457 9.75 6.25V2.75C9.75 2.62786 9.73905 2.50828 9.71808 2.39219L5.14652 7.68557L2.25 4.78905L3.17522 3.86384L5.07635 5.76497L8.75973 1.5L9.70236 2.31408C9.50342 1.41914 8.70485 0.75 7.75 0.75H4.25Z" fill="#FFFFFF" />
          </svg>
        </DivIcon>
      );
    case "bill":
